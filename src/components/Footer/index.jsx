            ...
            <nav className="navbar navbar-expand navbar-light bg-dark justify-content-center fixed-bottom">
                <div id="navbarNavAltMarkup">
                    <div className="navbar-nav">
                        ...
                        <a className="nav-link text-light fw-bold" href="https://open.spotify.com/user/nickais?si=3IA86MWLSj-BGmHZkMz5Lw"><img className="logo" src="./images/spotify.png" alt="Spotify Logo"></img></a>
                    </div>
                </div>
            </nav>
        </>
